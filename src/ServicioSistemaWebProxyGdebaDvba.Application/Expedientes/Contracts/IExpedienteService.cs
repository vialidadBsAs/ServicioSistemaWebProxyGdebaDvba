...
public interface IExpedienteService
{
    ...
    Task<DescubrirExpedientesProgramadosResult> DescubrirExpedientesProgramadosAsync(DescubrirExpedientesProgramadosRequest request, CancellationToken cancellationToken);
