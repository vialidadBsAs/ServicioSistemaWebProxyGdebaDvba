...
public sealed class TemaExpedienteConfiguration : IEntityTypeConfiguration<TemaExpediente>
{
    public void Configure(EntityTypeBuilder<TemaExpediente> builder)
    {
        ...
        builder.Property(x => x.UsuarioPropietario).HasMaxLength(100).IsRequired();
        // El codigo es unico por dueno: dos usuarios pueden tener cada uno su tema "OBRAS".
        builder.HasIndex(x => new { x.UsuarioPropietario, x.Codigo }).IsUnique();
