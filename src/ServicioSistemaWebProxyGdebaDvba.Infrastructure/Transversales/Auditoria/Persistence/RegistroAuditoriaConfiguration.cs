...
namespace ServicioSistemaWebProxyGdebaDvba.Infrastructure.Transversales.Auditoria.Persistence;
...
public sealed class RegistroAuditoriaConfiguration : IEntityTypeConfiguration<RegistroAuditoria>
{
    public void Configure(EntityTypeBuilder<RegistroAuditoria> builder)
    {
        ...
        builder.HasIndex(x => new { x.AplicacionConsumidoraId, x.OperacionSolicitada, x.Fecha });
